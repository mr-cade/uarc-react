...
export default function Home() {
    return (
        <div className="col-6 mx-auto mt-5">
            ...
            <p>This site includes information about the club's history and current activities, as well as answers to the most frequently asked questions about Amateur Radio in Utah and Amateur Radio in general. We hope you find it useful. Suggestions are always appreciated.</p>
            <p>Have a question not answered here? Call UARC's Ham Hotline, 583-3002. A volunteer will either be available in person or, generally, will get back to you within 24 hours.</p>
        </div>
    )
}